...
export const projects: Project[] = [
  {
    ...
    description: 'A full-stack genealogy platform combining interactive tree visualization, family event notifications, and a multilingual AI assistant for family history.',
    longDescription: 'A full-stack genealogy platform that lets families map their lineage, preserve history, and stay connected — combining interactive tree visualization with real-time communication and an AI assistant that can answer virtually any question about the family, even beyond what\'s explicitly recorded.',
    fileName: 'family-tree-web-app',
    status: 'in-progress',
    tags: ['React', 'TypeScript', 'Vite', 'Tailwind CSS v4', 'Django', 'Django REST Framework'],
    ...
    caseStudy: {
      ...
      outcome: 'Core tree, person/relationship management, tagging, and events system are built and functional. Email notifications and the multilingual AI assistant are in active development.',
    },
  },
  {
    slug: 'nera-exchange',
